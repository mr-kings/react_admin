		...
		return (
			<div className="chart-container" style={style}>
				<div className="header">
					...
					<div className="operations">
						<div className="icon" onClick={this.customInteraction1}>
							<img
								src="http://img.alicdn.com/tfs/TB1WY27xamWBuNjy1XaXXXCbXXa-48-48.png"
								alt="1"
							/>
						</div>
						<div className="icon" onClick={this.customInteraction2}>
							<img
								src="http://img.alicdn.com/tfs/TB1Hfmaxf9TBuNjy0FcXXbeiFXa-48-48.png"
								alt="1"
							/>
						</div>
						<div className="icon" onClick={this.downloadChartScreenShot}>
							<img
								src="http://img.alicdn.com/tfs/TB1HuvPxf1TBuNjy0FjXXajyXXa-128-128.png"
								alt="1"
							/>
						</div>
					</div>
				...
				<div className="content">
					<Compo
						data={data[item.key] || []}
						updateInstance={this.getChartInstance}
					/>
				</div>
			</div>
		);
